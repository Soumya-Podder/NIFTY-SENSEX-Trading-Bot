...
The project `.env` sets a ₹20,000 monthly gross profit target before charges and taxes, ₹1,200 daily-loss limit and hard halt, ₹600 planned-loss allocation, and ₹200 execution reserve. The current per-trade risk override is ₹750; the correlated open-risk veto remains ₹600 with one open position. The monthly target is a tracking objective and does not initiate a daily profit lock. These are targets and controls; executable fills cannot be guaranteed during gaps or unavailable liquidity.
