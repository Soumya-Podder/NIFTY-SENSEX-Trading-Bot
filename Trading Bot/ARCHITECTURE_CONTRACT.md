...
- Maximum planned loss per trade is **₹600**. The correlated open-risk veto is also **₹600**.
- The hard daily halt is **₹800**, consisting of a ₹600 planned loss allocation plus a ₹200 execution reserve.
